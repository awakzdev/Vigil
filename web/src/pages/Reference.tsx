...
const rows: ReferenceRow[] = [
  ...
  { key: "github.org", value: "GitHub organization-level identity findings — MFA enforcement and dormant members.", examples: ["github.org.mfa_not_enforced", "github.org.dormant_members"], group: "GitHub" },
  { key: "github.repo", value: "GitHub repository change-management findings — branch protection, self-merge, and review coverage.", examples: ["github.repo.no_branch_protection", "github.repo.self_merge_allowed", "github.repo.insufficient_reviews"], group: "GitHub" },
