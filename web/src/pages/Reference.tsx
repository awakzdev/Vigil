...
const rows: ReferenceRow[] = [
  ...
  { key: "iam.user", value: "IAM users collected from the account, including direct policy attachments.", examples: ["iam.user.no_mfa", "iam.user.inactive_90d", "iam.user.direct_policy_attachment"], group: "IAM" },
  ...
  { key: "github.repo", value: "GitHub repository change-management findings — branch protection, CODEOWNERS, environment protection, self-merge, and review coverage.", examples: ["github.repo.no_branch_protection", "github.repo.no_codeowners", "github.repo.no_env_protection", "github.repo.self_merge_allowed"], group: "GitHub" },
